...
def start(client, message):
   Yᴇᴀɢᴇʀɪsᴛ Bᴏᴛs = f"👋 𝗛𝗲𝗹𝗹𝗼 @{message.from_user.username} just enjoy"
    message.reply_text(
        text=Yᴇᴀɢᴇʀɪsᴛ Bᴏᴛs , 
        quote=False,
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton('Updates 👬', url=f"https://t.me/Animemusicarchive6"),
                    InlineKeyboardButton('Support 🤗', url=f"https://t.me/Yeageristbots")
                ]
            ]
        )
    )
